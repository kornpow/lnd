...
func (m *MockFeeFunction) IncreaseFeeRate() error {
	args := m.Called()

	return args.Error(0)
}

// SkipFeeBump returns true if a fee bump can be skipped.
func (m *MockFeeFunction) SkipFeeBump(confTarget uint32) bool {
	args := m.Called()
